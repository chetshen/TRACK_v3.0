...
clear
%%
filename='snst_hammer_onsup_5k_kp_kb_tight_damping_slpEI_N5000.mat';
[inp,NNslpf] = get_input_vtrack();
inp.ext_force.x = [1.5,-0.12,0];
...
valRange = [slp_EI*1.5,slp_EI*3; % Sleeper EI
%             1.05e2,1.58e2; % Sleeper rhoA
            1e7,3e8;     % Railpad Stiffness 1e8,1.5e9;
            4e4,9e4;       % Railpad damping
            2e7/NNslpf/5, 11e7/NNslpf/5;
            5e4/NNslpf/25, 9e4/NNslpf/25];
