%%
%FE model by Chen parametric study
%%
...
in_data.mater(4).Data = [4.8458e7/17;  %4.8458e7/5;K_Spring_SB[N/m]
                         3.444e4/17];%3.444e4/5];  %C_Damper_SB[N.s/m]
...
in_data.mater(7).Data=[210e8;    %E_R[N/m^2]
                   2.3379e-5;    %I_R[m^4]
                    6.977e-3;    %A_R[m^3]
                        7800;    %rho_R[kg/m^3]
                      8.1e10;    %G_R
...
% 
in_data.mater(10).Data = 2/3*in_data.mater(1).Data(1)/(1-0.27^2)*sqrt(in_data.geo.Rw) ;%1.1e9; %C_Hertz %2/3*in_data.mater.E_R/(1-0.27^2)*sqrt(in_data.geo.Rw) ;% 8.7e10; %[N/m^(3/2)] from (Steffens, 2005)
