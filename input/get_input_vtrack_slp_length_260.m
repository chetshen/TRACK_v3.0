...
in_data.geo.Ltot_R=3.125;                  %[m]
in_data.geo.SlpSpc=0.125;           %[m] 
in_data.geo.dist_S=in_data.geo.SlpSpc; %[m] 
in_data.geo.LExt_S=0.13;             %[m]
in_data.geo.LInt_S=0.13;              %[m]
in_data.geo.TrackWidth=0.26;            %[m]
% in_data.geo.Ltot_S=in_data.geo.LExt_S*2+in_data.geo.TrackWidth;      %[m] full length=2.36[m])
in_data.geo.dist_RS=0.02;               %[m] Between rails and sleepers
...
in_data.ext_force.x=[1.5,-0.16,-0.2];
...
in_data.mesh.m_1S_Ext=13;                %Number of elements in a sleeper external
in_data.mesh.m_1S_Int=26;                %Number of elements in a sleeper internal
...
in_data.mater(2).Data=[210e9; % #19.4e12# or #19.4e9# [N/m^2]                    	
                    1.12500e-8;  %[m^4]
                    0.04*0.015; %[m^2]
                    7800;%2140;%3070;   %2480[kg/m^3]
                    210e9/2.1; %E/2.34
                    0.4]; %0.833
...
in_data.mater(3).Data=[5e7; %1.56e9;%1.3e9; %K_Spring_RS [N/m]
