...
%%
function [in_data,NNslpf] = get_input_Zhang_2019(in_data)
%%
%Geometry input

in_data.geo.Ltot_R=26;                  %[m]
...
in_data.mater(3).Data=[90e6;%70e6; %K_Spring_RS [N/m]
...
in_data.mater(4).Data = [170e6/NNslpf;  %3e7 K_Spring_SB[N/m]
                         55e3/NNslpf];%3.1e4];  %C_Damper_SB[N.s/m]
