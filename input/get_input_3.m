...
in_data.geo.LExt_S=1;             %[m]
in_data.geo.LInt_S=1.5;              %[m]
in_data.geo.TrackWidth=3;            %[m]
...
in_data.mesh.m_1S_Int=48;                %Number of elements in a sleeper internal
...
in_data.mater(2).Data=[43e9; % #19.4e12# or #19.4e9# [N/m^2]
                    1.65e-4;  %[m^4]
                    0.0436; %[m^2]
                    2752.3;%2140;%3070;   %2480[kg/m^3]
                    1.87e10; %E/2.34
                    0.83]; %0.833
