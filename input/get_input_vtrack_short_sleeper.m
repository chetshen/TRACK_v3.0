...
in_data.geo.LExt_S=0.09;             %[m]
in_data.geo.LInt_S=0.09;              %[m]
in_data.geo.TrackWidth=0.18;            %[m]
...
in_data.mesh.m_1S_Ext=9;                %Number of elements in a sleeper external
in_data.mesh.m_1S_Int=18;                %Number of elements in a sleeper internal
